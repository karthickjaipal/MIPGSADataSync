...
public class ReadExcelData {
	...
	public List<RootEditCustomerdto> readEditData()
	{
		List<RootEditCustomerdto> editlist=null;
		try{
		FileInputStream fis=new FileInputStream("D:\\testdatanew.xlsx");
		XSSFWorkbook wb=new XSSFWorkbook(fis);
		XSSFSheet sh = wb.getSheet("editdata");
		int rownum=sh.getLastRowNum();
		
		editlist=new ArrayList<RootEditCustomerdto>();
		for(int i=1;i<=rownum;i++)
		{
			
			NomineeDetailsdto nomDto;
			List<NomineeDetailsdto> nomlist=new ArrayList<NomineeDetailsdto>();
			if(!sh.getRow(i).getCell(27).getStringCellValue().equals("null"))
			{
				
				nomDto= new NomineeDetailsdto();
				nomDto.setName(sh.getRow(i).getCell(27).getStringCellValue());
				nomDto.setAge(Integer.parseInt(sh.getRow(i).getCell(28).getStringCellValue()));
				nomDto.setMsisdn(sh.getRow(i).getCell(29).getStringCellValue());
				nomDto.setGender(sh.getRow(i).getCell(30).getStringCellValue());
				nomDto.setRelationship(sh.getRow(i).getCell(31).getStringCellValue());
				nomlist.add(nomDto);
				//checkwhether 34 has value
				if(!sh.getRow(i).getCell(32).getStringCellValue().equals("null"))
				{
					...
					if(!sh.getRow(i).getCell(37).getStringCellValue().equals("null"))
					{
						...
						if(!sh.getRow(i).getCell(42).getStringCellValue().equalsIgnoreCase("null"))
						{
							nomDto= new NomineeDetailsdto();
							nomDto.setName(sh.getRow(i).getCell(42).getStringCellValue());
							nomDto.setAge(Integer.parseInt(sh.getRow(i).getCell(43).getStringCellValue()));
			...
			//List of Subscriptions
			List<EditSubscriptionDetailsdto> sublist=new ArrayList<EditSubscriptionDetailsdto>();
			/*
			 * Life subscriptions
			 * Hospital subscriptions
			 * 
			 */
			EditSubscriptionDetailsdto editSubDto;
			//SubscriptionDetailsdto hosSubDto=null;



			if(!sh.getRow(i).getCell(12).getStringCellValue().equals("null"))
			{
				/*
				 * true
				 * Capture Life details Mandatory
				 ...
				 */
				//System.out.println("Entered1 :"+i);
				editSubDto=new EditSubscriptionDetailsdto();
				editSubDto.setOfferId(Integer.parseInt(sh.getRow(i).getCell(12).getStringCellValue()));
				editSubDto.setOfferCoverId(Integer.parseInt(sh.getRow(i).getCell(13).getStringCellValue()));
				editSubDto.setHealthTipsSmsFrequency(Integer.parseInt(sh.getRow(i).getCell(14).getStringCellValue()));
				editSubDto.setHealthTipsSmsLang(sh.getRow(i).getCell(15).getStringCellValue());
				editSubDto.setPaymentChannelId(Integer.parseInt(sh.getRow(i).getCell(16).getStringCellValue()));
				editSubDto.setNomineeDetails(nomlist);
				sublist.add(editSubDto);
				if (!sh.getRow(i).getCell(17).getStringCellValue().equals("null"))
				{  
					/*
					 * true
					 * Capture Hospital details Mandatory
					...
					//System.out.println("Entered1 :"+i);
					editSubDto=new EditSubscriptionDetailsdto();
					editSubDto.setOfferId(Integer.parseInt(sh.getRow(i).getCell(17).getStringCellValue()));
					editSubDto.setOfferCoverId(Integer.parseInt(sh.getRow(i).getCell(18).getStringCellValue()));
					editSubDto.setHealthTipsSmsFrequency(Integer.parseInt(sh.getRow(i).getCell(19).getStringCellValue()));
					editSubDto.setHealthTipsSmsLang(sh.getRow(i).getCell(20).getStringCellValue());
					editSubDto.setPaymentChannelId(Integer.parseInt(sh.getRow(i).getCell(21).getStringCellValue()));
					editSubDto.setNomineeDetails(nomlist);
					sublist.add(editSubDto);

					if(!sh.getRow(i).getCell(22).getStringCellValue().equals("null"))
					{  
						/*
						 * true
						 * Capture Bundle details Mandatory
						...
						//System.out.println("Entered1 :"+i);
						editSubDto=new EditSubscriptionDetailsdto();
						editSubDto.setOfferId(Integer.parseInt(sh.getRow(i).getCell(22).getStringCellValue()));
						editSubDto.setOfferCoverId(Integer.parseInt(sh.getRow(i).getCell(23).getStringCellValue()));
						editSubDto.setHealthTipsSmsFrequency(Integer.parseInt(sh.getRow(i).getCell(24).getStringCellValue()));
						editSubDto.setHealthTipsSmsLang(sh.getRow(i).getCell(25).getStringCellValue());
						editSubDto.setPaymentChannelId(Integer.parseInt(sh.getRow(i).getCell(26).getStringCellValue()));
						editSubDto.setNomineeDetails(nomlist);
						sublist.add(editSubDto);
					}
				}
			...
			List<Documentdetailsdto> doclist=new ArrayList<Documentdetailsdto>();
			
			Documentdetailsdto docdto;
			if(!sh.getRow(i).getCell(6).getStringCellValue().equals("null"))
			{
			docdto=new Documentdetailsdto();
			docdto.setDocumentTypeId(Integer.parseInt(sh.getRow(i).getCell(6).getStringCellValue()));
			docdto.setDocumentValue(sh.getRow(i).getCell(7).getStringCellValue());
			doclist.add(docdto);
			if(!sh.getRow(i).getCell(8).getStringCellValue().equals("null"))
			{
				docdto=new Documentdetailsdto();
				docdto.setDocumentTypeId(Integer.parseInt(sh.getRow(i).getCell(8).getStringCellValue()));
				docdto.setDocumentValue(sh.getRow(i).getCell(9).getStringCellValue());
				doclist.add(docdto);
				if(!sh.getRow(i).getCell(10).getStringCellValue().equals("null"))
				{
					docdto=new Documentdetailsdto();
					docdto.setDocumentTypeId(Integer.parseInt(sh.getRow(i).getCell(10).getStringCellValue()));
					docdto.setDocumentValue(sh.getRow(i).getCell(11).getStringCellValue());
					doclist.add(docdto);
				}
			}
			}
			
			EditCustomerDetailsdto editCustomerdto=new EditCustomerDetailsdto();
			editCustomerdto.setCustomerName(sh.getRow(i).getCell(0).getStringCellValue());
			editCustomerdto.setCustomerAge(Integer.parseInt(sh.getRow(i).getCell(1).getStringCellValue()));
			editCustomerdto.setCustomerGender(sh.getRow(i).getCell(2).getStringCellValue());
			editCustomerdto.setCustomerMsisdn(sh.getRow(i).getCell(3).getStringCellValue());
			editCustomerdto.setModifiedBy(Integer.parseInt(sh.getRow(i).getCell(4).getStringCellValue()));
			editCustomerdto.setModifiedDate(sh.getRow(i).getCell(5).getStringCellValue());
			editCustomerdto.setDocumentDetails(doclist);


			
			EditCustomerdto editCustomer=new EditCustomerdto();
			editCustomer.setCustomerDetails(editCustomerdto);
			editCustomer.setCurrentSubscriptions(sublist);
			
			
			RootEditCustomerdto rootDto=new RootEditCustomerdto();
			rootDto.setEditCustomer(editCustomer);
			
			editlist.add(rootDto);
		}
		}catch(Exception e)
		{
			e.printStackTrace();
...
/*		List<RootCustomerdto> customerdata = red.readRegData();
		...
		String editJsonStr=null;
		ObjectMapper Obj = new ObjectMapper();
		for(RootEditCustomerdto editObj: editlist)
		{
			try {
				editJsonStr=Obj.writeValueAsString(editObj);
				System.out.println(editJsonStr);
